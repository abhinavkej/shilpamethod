      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 text-[12px] text-cream/50 leading-relaxed">
          <div>
            ...
            <p>
              The Hormone Method Boot Camp is educational guidance, not medical advice.
        ...
        <div className="mt-10 pt-6 border-t border-cream/10 flex justify-between items-center text-[11px] text-cream/40">
          <span>© 2026 The Hormone Method · Forum Health</span>
          <span className="font-mono tracking-widest uppercase">A Forum Health program</span>
        </div>
      </div>
    </footer>
  )
