...
export const riskQuestions: RiskQuestion[] = [
  {
    ...
    helperText:
      "Blood clots can present as a stroke, a clot in the leg (DVT), or unexplained repeat miscarriages. If unsure, 'Not sure' is a valid answer — Dr. Kai will help you clarify before the program.",
  },
  {
    id: 'cancer',
    question:
