...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. Dr. Saxena walks through the recommended lab panel, including what each marker tells you and how to interpret results. You'll leave with a specific list you can bring to your provider. Lab recommendations are educational — ordering, interpretation, and clinical decisions require a licensed provider in your state.",
  },
  {
